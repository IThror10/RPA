...
export class Api {
    ...
    public async put<Result, RequestBody>(url: string, data?: RequestBody, config?: AxiosRequestConfig) {
        const response = await this.axiosInstance.put<Result>(url, data, config);
        return response.data;
    }
